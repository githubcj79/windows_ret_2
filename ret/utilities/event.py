...
class Event(object):
    ...
    def __init__(self, type_=None, data={}, event_types=['mml_type']):
        """
        event_types: list of allowed event_types
        """
        ...
        self.type_ = type_
        self.is_valid_type_ = self.type_ in event_types#Event.types
        self.data = data
